...
class message {
    ...
    private String message_number_m, message_date,message_letter_attachments,message_type,message_subject,message_source,message_destination,message_is_urgent,message_send_method,message_is_sent,message_sender;
    
    public message(int message_id, String message_number_m,String message_date,String message_letter_attachments,String message_type,String message_subject,String message_source, String message_destination,String message_is_urgent,String message_send_method,String message_is_sent,String message_sender){
   ...
   public String getmessage_is_sent(){
