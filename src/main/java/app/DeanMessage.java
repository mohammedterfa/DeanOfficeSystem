...
public class DeanMessage {
    ...
    private String message_number_m, message_date,message_letter_attachments,message_type,message_subject,message_destination,message_is_urgent,message_send_method,message_signature;
    
    public DeanMessage(int message_id, String message_number_m,String message_date,String message_letter_attachments,String message_type,String message_subject, String message_destination,String message_is_urgent,String message_send_method,String message_signature){
